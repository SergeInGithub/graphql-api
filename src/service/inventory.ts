...
// Register a inventory transactions and updates the warehouse warehouse stocks.
// @param type type of transaction
// @param productId product that are going to be transacted
// @param warehouse target warehouse that the quantity is going to be UpdateDateColumn.
...
export const registerTransaction = async (
  ...
  if (!warehouseStock.productId || !warehouseStock.warehouseId) {
    //* There is no stock record for the given product and warehouse yet. Will create one.
